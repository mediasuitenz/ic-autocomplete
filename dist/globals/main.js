...
exports["default"] = Ember.HTMLBars.template((function() {
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      inline(env, morph0, context, "ic-autocomplete-input", [], {"value": get(env, context, "inputValue"), "aria-label": get(env, context, "placeholder"), "placeholder": get(env, context, "placeholder")});
      block(env, morph1, context, "ic-autocomplete-toggle", [], {}, child0, null);
      block(env, morph2, context, "ic-autocomplete-list", [], {}, child1, null);
      return fragment;
    }
  };
}()));
